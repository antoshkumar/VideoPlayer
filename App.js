 ...
 */
 ...
 const ICON_MUTED_BUTTON = new Icon(
   require("./assets/images/muted_button.jpg"),
   67,
   58
 );
 const ICON_UNMUTED_BUTTON = new Icon(
   require("./assets/images/unmuted_button.jpg"),
   67,
   58
 );
...
{/*  all event view button action here................ */}
         <View style={styles.event_View}>

    {/* on tab back button action here................. */}
              <TouchableHighlight
               ...
               disabled={this.state.isLoading}
              >
              <AntDesign name="banckward" size={24} color="black" style={styles.backword_button} />
             </TouchableHighlight>

    {/* on play button action here................................            */}
            <TouchableHighlight
                  underlayColor={BACKGROUND_COLOR}
                  style={styles.wrapper}
           ...
           <TouchableHighlight
             ...
             disabled={this.state.isLoading}
           >
            <AntDesign name="forward" size={24} color="black" style={styles.farword_Button} />
           </TouchableHighlight>

  {/* valume buttom action here...................          */}
  <TouchableHighlight
               underlayColor={BACKGROUND_COLOR}
               style={styles.wrapper}
...
<TouchableHighlight
               ...
               >
                <MaterialCommunityIcons name="move-resize-variant" size={24} color="black" />
               </TouchableHighlight>
